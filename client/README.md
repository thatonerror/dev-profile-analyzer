# Backend
cd server
npm install socket.io mongoose nodemailer uuid
          ...
          <div className="flex justify-between items-start mb-6">
            ...
            <div className="flex items-center gap-2">
              <a
                ...
                className="flex items-center gap-2 bg-green-600/20 hover:bg-green-600/30 border border-green-500/50 px-4 py-2 rounded-xl transition text-sm sm:text-base"
              >
      ...
      <AuthProvider>
        <SocketProvider>
          <Routes>
            ...
            {/* Chat Room - Public (anyone with link can join) */}
